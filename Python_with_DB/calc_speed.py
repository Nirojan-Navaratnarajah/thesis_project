...
def capture_packets(interface):
    sniff(iface=interface, prn=process_packet, filter="ether dst host 08:97:98:DD:EF:61", store=0)
...
window.after(10, calculate_speed)  # Start the speed calculation loop
window.mainloop()
